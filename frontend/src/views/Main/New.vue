        ...
        <div class="QueryInputPart ColorBox">
            ...
            <svg class="DBAttrBody">
                ...
                <rect
                    ...
                    :stroke="BaseColorMap['grey-normal']"
                ></rect>
                <g class="queryInputLegend" transform="translate(-5, 550)">
                    <g transform="translate(0, 45)">
                        <text x="30" y="-85" class="legendMText">Edges:</text>
                        <g transform="translate(0, -80)">
                            ...
                            ></line>
                            <text x="80" y="10" class="legendMText">To be explored</text>
                        </g>
                        ...
                        <g transform="translate(0, -60)">
                            <line
                                ...
                                :stroke="BaseColorMap['grey-normal']"
                            ></line>
                            <text x="80" y="10" class="legendMText">Known</text>
                        </g>
                    </g>
                    <g transform="translate(0, 25)">
                        ...
                        <path
                                ...
                                fill="none"
                        ></path>
                        <text x="80" y="20" class="legendMText">
                            Known
                        </text>
                        <text x="80" y="35" class="legendMText">
                            (width-95% CI)
                        </text>
                    </g>
                    <g transform="translate(0, 60)">
                        <path
                                ...
                                fill="none"
                        ></path>
                        <text x="80" y="20" class="legendMText">Simulated</text>
                    </g>
                </g>
    ...
    <div class="MidPart">
        <div class="QueryTemplatePart ColorBox">
            <div class="QueryTemplateTop">
                <div class="MainHeading">Data Request Declaration</div>
                <el-divider border-style="dashed" class="TextDivider" />
                <!-- <div>Vis Type:</div>
      <el-select
        v-model="CurVisType"
      ...
      > -->
                ...
                <el-scrollbar max-height="250px" always="true">
                    <div
                        ...
                        <svg class="tickSvg">
                            ...
                            <g v-if="AttrTypeMap[cna] === '#'">
                                <g
                                        ...
                                        :transform="`translate(${
                      (200 / (AttrBinRangeMap[cna].length - 1)) * (i) + 5
                    }, 25)`"
                                >
                                    <polygon
                                ...
                                <text x="0" y="50" text-anchor="start" class="greySvgText">
                                    {{ AttrBinRangeMap[cna][0] > 1000 ? (AttrBinRangeMap[cna][0]/1000).toFixed(0) + 'k' : AttrBinRangeMap[cna][0]}}
                                </text>
                                <text x="200" y="50" text-anchor="middle" class="greySvgText">
                                    {{ AttrBinRangeMap[cna][AttrBinRangeMap[cna].length - 1] > 1000 ? (AttrBinRangeMap[cna][AttrBinRangeMap[cna].length - 1]/1000).toFixed(0) + 'k' : AttrBinRangeMap[cna][AttrBinRangeMap[cna].length - 1] }}
                                </text>
                            </g>
                            <g v-else>
                                <g
    ...
    <!--                                ></polygon>-->
            ...
            > -->
                  ...
                  (d) => !CurExeQuery.includes(d)
                    ...
                    <el-button style="margin: 0px 40% 0px 40%" @click="AddNewAttr">
            ...
            <div class="QueryTemplateBottom">
                ...
                <div class="FlexRow">
                    ...
                    <div class="SubSubHeading" style="margin-left: 80px">
                        Data request list
                    </div>
                </div>
                <el-scrollbar height="610px" always="true">
                    <div
        ...
        <div class="ChartPart ColorBox">
            <div class="MainChart">
                ...
                <svg id="QueryResultChart">
                    <g class="content"></g>
                    <g class="legend" transform="translate(40, 0)">
                        <g
                                class="errorbarLegend"
                                transform="translate(800, 43)"
                        ...
                        >
                            ...
                            <g class="innerG" transform="translate(450, 0)">
                                ...
                                <text x="-80" y="90" text-anchor="middle" class="legendMText">
                                    CI (95%):
                                </text>
                                <text x="190" y="90" text-anchor="middle" class="legendMText">
                                    in bars
                                </text>
                ...
                <div class="AttrFilterPanel">
                    ...
                    <div class="NosieModeChange FlexRow" v-if="PreExeQuery.length > 1">
                        <div>Result of:</div>
                        <el-switch
                            style="margin-left: 10px"
                            v-model="ShowMode"
                            size="middle"
                            active-text="All requests"
                            @change="showSummary"
                            :inactive-text="`The current request (&epsilon;: ${(CurExeEpsilon).toFixed(2)})`"
                        />
                    </div>
                    ...
                    <div class="NosieModeChange FlexRow" v-if="PreExeQuery.length > 1">
<!--                        <div class="CurExeEpsilonBar" >Current &epsilon;: {{CurExeEpsilon}}</div>-->
                        <div>Noise in results:</div>
                        <el-switch
                                style="margin-left: 10px"
                                v-model="noiseMode"
                                size="middle"
                                active-text="Included"
                                inactive-text="Randomly removed"
                        />
                        <el-button
                                @click="ResetHeatMap"
                                type="primary"
                    ...
                    <div class="NosieModeChange FlexRow" v-if="PreExeQuery.length > 1">
                        <!--                        <div class="CurExeEpsilonBar" >Current &epsilon;: {{CurExeEpsilon}}</div>-->
                        <div>Scale for numerical attributes:</div>
                        <el-switch
                            style="margin-left: 10px"
                            v-model="ScaleMode"
                            size="middle"
                            active-text="Interval"
                            inactive-text="Linear"
                            @change="ScaleModeChange"
                        />
                    </div>

                    <div class="FlexRow">
                        <div style="line-height: 32px" v-if="PreExeQuery.length > 1 && Object.keys(TotalAttrFilterMap).length===0">Filter: attribute-value</div>
                        <div style="line-height: 32px" v-if="PreExeQuery.length > 1 && Object.keys(TotalAttrFilterMap).length>0">
                            Filter:
                            <div class="FilterItem" v-for="attr in Object.keys(TotalAttrFilterMap)" style="margin-left: 10px">
                                <el-button
                                    @click="deleteFilterAttr(attr)"
                                    size="small"
                                ...
                                <span>{{attr}}-{{ TotalAttrFilterMap[attr] }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="FlexRow">
                        ...
                        >
                            <el-option
                                    ...
                                    v-for="item in ShowMode ? (Object.keys(TotalAttrFilterMap).length === TotalQueryAttrs.length-1 ? Object.keys(TotalAttrFilterMap) : TotalQueryAttrs)
                                     : (Object.keys(TotalAttrFilterMap).length === PreExeQuery.length-1 ? Object.keys(TotalAttrFilterMap) : PreExeQuery)"
                                    :key="item"
                                    :label="item"
                                    :value="item"
                            />
                        ...
                        >
                            <el-option
                                    ...
                                    :key="item"
                                    :label="item.split('~').length > 1 ? labelSwitch(item) : item"
                                    :value="item"
                            />
                        </el-select>
                    </div>
...
export default {
    ...
    data() {
        return {
            BaseColorMap: {
                ...
                "red-sensitive": "rgb(185,64,47)",
                "red-sensitive-opacity": "rgb(185,64,47)",
                ...
                'green-deep': 'rgba(0, 148, 50,1.0)',
                'yellow': 'rgb(255,251,233)',
            ...
            CurDatabase: "Customer Life Time value",
            BaseEpsilonMap: {
                'Customer Life Time value': 1.0,
                'National Health and Nutrition Examination Survey': 2.0
            },
            TotalEpsilonMap: {
                'Customer Life Time value': 1.0,
                'National Health and Nutrition Examination Survey': 2.0
            ...
            isFilter: false,
            AttrMessMap: {},
            ExplorationProgressVal: [0, 100, 100],
    ...
    computed: {
        CurFilterAttrList() {
            return Object.keys(this.TotalAttrFilterMap);
        },
        QueryRegionList() {
        ...
        CurFilterAttrRangeList() {
            let attrRange = this.AttrQueryBinRangeMap[this.CurFilterAttr];
            if (attrRange) {
        ...
        CurHeatMapColorScaleLegendList() {
            ...
            if (typeof this.CurHeatMapColorScale === "object") {
                ...
                return [...d3.range(domain[0], domain[4], (domain[4] - domain[0]) / 50), domain[4]];
            }
        },
        CurNumericalQuery() {
        ...
        CurFilterChange({ CurFilterAttr, CurFilterAttrRange, FilterChange }) {
            return { CurFilterAttr, CurFilterAttrRange, FilterChange };
        },
    ...
    watch: {
        ...
        CurFilterChange:{
            handler(newV, oldV) {
                new Promise(resolve => {
                    if(newV['CurFilterAttr'] !== oldV['CurFilterAttr'] && newV['CurFilterAttr'] !== '') {
                        this.$nextTick(() =>{
                            this.CurFilterAttrRange = this.CurFilterAttrRangeList[0];
                            this.TotalAttrFilterMap[newV['CurFilterAttr']] = this.CurFilterAttrRange;
                            resolve()
                        })
                    } else {
                        if(newV['CurFilterAttr'] === '') {
                            this.CurFilterAttrRange = ""
                            // delete this.TotalAttrFilterMap[oldV['CurFilterAttr']]
                        }
                        else {
                            if(this.CurFilterAttrRange === '') {
                                // delete this.TotalAttrFilterMap[newV['CurFilterAttr']]
                            }
                            else {
                                this.TotalAttrFilterMap[newV['CurFilterAttr']] = this.CurFilterAttrRange;
                            }
                    ...
                    if(!this.ShowMode) {
                        if (this.CurFilterAttrRange !== "") {
                            // 执行过滤
                            let temp;
                            let pre = this.Dataset;
                            for(let attr in this.TotalAttrFilterMap) {
                                let cfar = this.TotalAttrFilterMap[attr];
                                let isN = cfar.split("~").length > 1 ? true : false;
                                let [rangeL, rangeR] = cfar.split("~").map(
                                    (d) => +d
                                );
                                temp = pre.filter((d) => {
                                    if (isN) {
                                        return (
                                            d[attr] > rangeL && d[attr] < rangeR
                                        );
                                    } else {
                                        return d[attr] === cfar || +d[attr] === +cfar ;
                                    }
                                });
                                pre = temp;
                            }
                            this.CurExDataset = temp;
        ...
        CurQueryList: {
            handler(newValue, oldValue) {
                ...
                axios({
                    ...
                    qsltemp = data.strategyList;
                    if(qsltemp.length === 0) {
                        this.QueryStrategyList = [];
                        this.StrategySpecific = [];
                    }
                    sstemp = [];
                    let strategyMinRewardMap = {};
                    let strategyFinishedPromise = [];
                    for (let [idx, queryStategy] of Object.entries(
                        qsltemp
                    )) {
                        strategyFinishedPromise.push(new Promise(strategyResolve => {
                            ...
                            Promise.all(PromiseList).then((data) => {
                                ...
                                let EPV = this.ExplorationProgressVal;
                                let exactEPV = (EPV[1] - EPV[0])/(100 - EPV[0])*100
                                // 预算推荐
                                axios({
                                    method: "post",
                                    ...
                                    data: {
                                        ...
                                        rawQueryList: qsltemp[0],
                                        isRawQuery: +idx === 0,
                                        AttrRange: this.AttrBinRangeMap,
                                        ...
                                        'ExplorationProgressVal': exactEPV,
                                        'N': this.CurExDataset.length,
                                    },
                                }).then((response) => {
                                    let data = response.data;
                                    strategyMinRewardMap[idx] = data.minReward;

                                    sstemp[+idx] = {
                                        QuerySeq: data.QuerySeq,
                                        QueryEpsilonList: data.QueryEpsilonList, //data.QuerySeq.map(i => data.QueryEpsilonList[i]),
                                        QueryGranularity: data.QueryGranularity, //data.QuerySeq.map(i => data.QueryGranularity[i]),
                                    };
                                    qsltemp[idx] = data.QuerySeq.map(i => qsltemp[idx][i]);
                        ...
                        // 排序
                        Promise.all(strategyFinishedPromise).then(() => {
                            let indexList = Object.keys(strategyMinRewardMap);
                            indexList.sort((a, b) => strategyMinRewardMap[a] - strategyMinRewardMap[b]);
                            this.QueryStrategyList = indexList.map(d => qsltemp[d]);
                            this.StrategySpecific = indexList.map(d => sstemp[d]);

                            this.$nextTick(() => {
                                document.getElementById(`QueryRequest${this.CurQueryStrategyIdx}-${this.CurQueryIdx}`).click();
                            });
                        })
    ...
    methods: {
        // 通用类函数
        labelSwitch(label) {
          let labelList = label.split('~').map(d => +d > 1000 ? +d/1000 + 'k' : d);
        ...
        drawQueryResult(
            ...
            let [xScale, tickValues, bandwidthScale, bandwidth] = this.GetScale(
                ...
                [0, ticks1 * (RectWH + 5) + 5],
                true,
                [this.ScaleMode, queryAttrs[0]]
            );
            if(isNumericalX  && !this.ScaleMode) {
            ...
            // 添加坐标轴
            let CurQuery = this.PreExeQuery.filter((d) => !this.CurFilterAttrList.includes(d));
            ...
            if (i2 === 0) {
                if (CurQuery.length > 1 || this.ShowMode) {
                    svg
                        ...
                        .each(function () {
                            ...
                            let pre = textElement.text();
                            if(pre.split(' ').length > 1) {
                                textElement.html(`
                                    <tspan x="0" dy="-1em">${pre.split(' ')[0]}</tspan>
                                    <tspan x="5" dy="1em">${pre.split(' ')[1]}</tspan>
                                `)
                            }
                ...
                if (i1 === 0 && objectContainer.empty()) {
                    ...
                    if (CurQuery.length > 1 || this.ShowMode) {
                        ...
                        if(isNumericalX) {
                            yAxis.tickFormat(d => d >= 1000 ? (d/1000).toFixed(0) + 'k'  : d);
                        }
                    } else {
                        yAxis = d3.axisLeft(yScale).tickFormat(d => d >= 1000 ? (d/1000).toFixed(0) + 'k'  : d);
                    }
                    svg
                        .append("g")
                        .attr("class", "yAxis")
            ...
            if (!rectContainer.empty()) {
                ...
                rectContainerG
                    .append("rect")
                    .attr('class', 'SingleAttrBar')
                    .attr("x", ([category, value], i, a) => {
                        a[i].SvgHeight = SvgHeight;
                        a[i].noiseCount = noiseCount;
                        a[i].yScale = yScale;
                        a[i].isSensitiveQuery = isSensitiveQuery;
                        if (isNumericalX) {
                            let range = category.split("-").map((d) => Number(d));
                            if(this.ScaleMode) {
                                return xScale(range[0]) + 5 + bandwidth/2;
                            }
                            else {
                    ...
                    .attr("height", ([category, value], i, a) => {
                        if (this.noiseMode && (isSensitiveQuery || this.FilterSensitive)) {
                            ...
                            let y = +d3.select(a[i]).attr('y');
                            return Math.max(SvgHeight - 5 - y, 0)
                        }
                    })
                    ...
                    .attr("stroke", "none")
                    .append('title')
                    .text(([category, value], i, a) => {
                        return `Count: ${value.toFixed(0)}\nCI (95%): [${(value-quartileNoise).toFixed(0)}, ${(value+quartileNoise).toFixed(0)}]`
                    });
            ...
            if (!objectContainer.empty()) {
                ...
                let [yPosScale, yTickValues, yBandwidthScale, yBandwidth] =
                    this.GetScale(
                        ...
                        [0, ticks2 * (RectWH + 5) + 5 ],
                        true,
                        [this.ScaleMode, queryAttrs[1]]
                    );
                if(isNumericalY && !this.ScaleMode) {
                    yTickValues = this.AttrBinRangeMap[queryAttrs[1]];
                }
                if (i1 === 0) {
                    ...
                    svg
                        ...
                        .each(function () {
                            ...
                            if(pre.split(' ').length > 1) {
                                textElement.html(`
                                    <tspan x="-5" dy="-0.1em">${pre.split(' ')[0]}</tspan>
                                    <tspan x="-10" dy="1em">${pre.split(' ')[1]}</tspan>
                                `)
                            }
                ...
                let innerG = objectContainer
                    .attr("bandwidth", ([category, value]) => {
                        ...
                        if(this.ScaleMode) {
                            ...
                            return RectWH * t + 5 * (t-1);
                        }

                    })
                    .attr("transform", ([category, value], i) => {
                        let xTrans;
                        if(this.ScaleMode) xPn = 0
        ...
        showSummary() {
            ...
            if(isFilter === true) {
                                ...
                                if (i1 !== i2) {
                                    ...
                                    if (isFirst) {
                                        ...
                                        this.CurHeatMapColorScale = d3
                                            ...
                                            .range([
                                                this.BaseColorMap["color1"],
                                                this.BaseColorMap["color2"],
                                                this.BaseColorMap["color3"],
                                                this.BaseColorMap["color4"],
                                                this.BaseColorMap["color5"],
                                            ]);
                                    } else {
                                        const temp = Object.entries(queryRes);
                                        let scaleDomain = this.CurHeatMapColorScale.domain();
                                        let domainMax = scaleDomain[4];
                                        ...
                                        let maxVal = Math.max(domainMax, nowMax);
                                        this.CurHeatMapColorScale.domain([
                                            -maxVal,
                                            -0.2*maxVal,
                                            0,
                                            0.2*maxVal,
                ...
                svg
                    ...
                    .attr("height", this.SvgWidth - padding - 5)
                    .attr("fill", this.BaseColorMap["grey-deep"]);
                let TotalQueryAttrs = this.TotalQueryAttrs.filter((d) => !this.CurFilterAttrList.includes(d));
                let QueryAttrNamesLen = TotalQueryAttrs.length;
                let TotalQueryResults = this.TotalQueryResults;
                let ticksList = [];
                let totalTicks = TotalQueryAttrs.reduce((prev, cur) => {
        ...
        deleteFilterAttr(attr) {
          delete this.TotalAttrFilterMap[attr];
          if(this.CurFilterAttr === attr) {
              let taf = Object.keys(this.TotalAttrFilterMap);
              if(taf.length === 0) {
                  this.CurFilterAttr = ''
              }
              else {
                  this.CurFilterAttr = taf[0]
                  this.CurFilterAttrRange = this.TotalAttrFilterMap[taf[0]]
              }
          }
          else {
            this.FilterChange += 1;
        ...
        confirmText() {
            ...
            d3.select(`#${this.CurLineName}text`).html(
                `<tspan fill="rgb(220,220,220)">${this.SimulatedCorrelationMap[this.CurLineName]}</tspan>
                 <tspan fill="#666">-</tspan>
                 <tspan fill="rgb(150,150,150)">?</tspan>
                 `
            );
        ...
        ResetHeatMap() {
            ...
            let epsilon = this.CurExeEpsilon;
            d3.selectAll(".SingleAttrBar")
                .attr("y", ([category, value], i, a) => {
                    let noiseCount = a[i].noiseCount;
                    let yScale = a[i].yScale;
                    let isSensitiveQuery = a[i].isSensitiveQuery;
                    if (this.noiseMode && (isSensitiveQuery || this.FilterSensitive)) {
                        return yScale(value);
                    } else {
                        return yScale(
                            value -
                            this.getMultiNoise(1 / epsilon, noiseCount)
                        );
                    }
            })
                .attr("height", ([category, value], i, a) => {
                    let SvgHeight = a[i].SvgHeight;
                    let yScale = a[i].yScale;
                    let isSensitiveQuery = a[i].isSensitiveQuery;
                    if (this.noiseMode && (isSensitiveQuery || this.FilterSensitive)) {
                        return Math.max(SvgHeight - 5 - yScale(value), 0)
        ...
        QueryConfirmWithEpsilon() {
            ...
            this.CurExeEpsilon = +this.CurQueryEpsilonInput;
            this.PreQueryEpsilon = this.CurQueryEpsilonInput;

            let addVal = Math.round((this.CurExeEpsilon / this.BaseEpsilonMap[this.CurDatabase]) * 100);
            this.ExplorationProgressVal = [this.ExplorationProgressVal[0]+addVal, this.ExplorationProgressVal[1], 100];
        ...
        QueryConfirm(PreExeQuery, PreQueryEpsilon) {
            ...
            CurQuery = CurQuery.filter((d) => !this.CurFilterAttrList.includes(d));
            if (CurQuery.length <= 1) {
                let ticksList = [];
                let SVGSize = [
                    this.SvgWidth - padding - 10 - 20,
                    this.SvgHeight - 2.2*padding - 9 - 30,
                ];
                ...
                svg.select('rect').attr("height", SVGSize[1] + 15)
                let RectWH = (this.SvgWidth - padding - 20) / totalTicks - 5;
                let yTickNum = SVGSize[1] / (RectWH+5);
                let QueryContent = this.CurQueryContent;
                this.executeQuery(CurQuery, QueryContent).then(
                    ([queryRes, axisAttr]) => {
                        ...
                        let chartContainer = svg
                            ...
                            .attr(
                                "transform",
                                `translate(${1.0 * padding + 5}, ${padding * 1.8 + 5})`
                            )
                        ...
                        svg
                            ...
                            .attr(
                                "x",
                                1.6*padding + (ticksList[0] * (RectWH + 5)) / 2 + 10 - 40 - 20
                            )
                            .attr("y", 1010)
                            .attr("text-anchor", "middle")
                            .text(CurQuery[0]);
            ...
            // 多属性的情况
                ...
                let ticksList = [];
                let rangeMap = this.ScaleMode ? this.AttrQueryBinRangeMap : this.AttrBinRangeMap;
                let totalTicks = QueryAttrNames.reduce((prev, cur) => {
                    let attrBinRange = rangeMap[cur];
                    let ticks =
                        typeof attrBinRange[0] === "number"
                            ? attrBinRange.length - 1
                            : attrBinRange.length;
                    ...
                    for (let i in CurQuery) {
                        ...
                        for (let j in CurQuery) {
                            if (i != j) {
                                ...
                                if(this.VerifiedCorrelationMap[lineName]) {
                            ...
                            axios({
                                ...
                                data: {
                                    ...
                                    QueryResList: CurQuery.map(
                                        (d) => this.VerifiedDataRecord[d] ? this.VerifiedDataRecord[d] : this.simulateDataRecord[d]
                                    ),
            ...
            if (!this.isSimulation) {
                ...
                if (QueryAttrs.length > 1) {
                    if (this.AttrSensitive[QueryAttrs[0]]) {
                        ...
                        if(this.VerifiedDataRecord[QueryAttrs[0]] === undefined) {
                            ...
                            this.updateAttrHistogram(this.CurThisNodeName)
                        }
                        ...
                        if(this.VerifiedDataRecord[QueryAttrs[1]] === undefined) {
        ...
        chooseCurQuery(strategyI, queryI) {
            ...
            this.$nextTick(() => {
                for (let i in this.CurExeQuery) {
                    // if (granularity[i] === 1) {
                    //     this.AttrQueryBinRangeMap[this.CurExeQuery[+i]] = this.AttrBinRangeMap[this.CurExeQuery[+i]].map(d => d);
                    // } else if (granularity[i] === 2) {
                    //     this.AttrQueryBinRangeMap[this.CurExeQuery[+i]] = this.AttrBinRangeMap[this.CurExeQuery[+i]].filter(
                    //         (d, i) => i % 2 === 0
                    //     );
                    ...
                    let cur = 0;
                    let leftIdx = []
                    if(Array.isArray(granularity[i])) {
                        for (let v of granularity[i]) {
                            leftIdx.push(cur)
                            cur += v
                        }
                        leftIdx.push(cur)
                        this.AttrQueryBinRangeMap[this.CurExeQuery[+i]] = leftIdx.map(d => this.AttrBinRangeMap[this.CurExeQuery[+i]][d])
                    }
                    else {
                        this.AttrQueryBinRangeMap[this.CurExeQuery[+i]] = this.AttrBinRangeMap[this.CurExeQuery[+i]].map(d => d);
                    }
        ...
        // 细节类函数
        GetScale(isNumerical, domain, range, isFilledDomain, ScaleModeParams) {
            let scale, tickValues, bandwidthScale, bandwidth;
            if (isNumerical) {
                // 数值型
                let ScaleMode = ScaleModeParams !== undefined ? ScaleModeParams[0] : false
                if(!ScaleMode) {
                    ...
                    let [ScaleMode, attr] = ScaleModeParams;
                    let intervalDomain = this.AttrQueryBinRangeMap[attr];
                    scale = d3.scaleBand().domain(intervalDomain).range(range);
                    tickValues = scale.domain();
                    bandwidth = scale.bandwidth();
                    scale = d3.scaleBand().domain(intervalDomain).range([range[0]-bandwidth/2, range[1]+bandwidth/2]);
                    bandwidth = scale.bandwidth();
                }
            ...
            if (
                ...
                return new Promise((resolve) => {
                    axios({
                        ...
                        data: {
                            ...
                            QueryResList: [
                                this.VerifiedDataRecord[a1] ? this.VerifiedDataRecord[a1] : this.simulateDataRecord[a1],
                                this.VerifiedDataRecord[a2] ? this.VerifiedDataRecord[a2] : this.simulateDataRecord[a2],
                            ],
                            QueryBinRangeList: [
                ...
                if (!is) {
                    axios({
                        ...
                        let lineName = `${NodeNameList[0]}±${NodeNameList[1]}`;
                        this.VerifiedCorrelationMap[lineName] =
                            (Math.floor(response.data.correlation*100)/100).toFixed(2);
                        let lineSelected = d3.select(`#${lineName}`).classed("chosenQuery");
                        if(lineSelected) {
                            d3.select(`#${lineName}`)
                                .classed("exeQuery", true)
                                .classed("chosenQuery", false)
                                .attr("stroke", this.BaseColorMap["grey-light"]);

                            if(this.specialAttrList.includes(NodeNameList[0]) || this.specialAttrList.includes(NodeNameList[1])) {
                                d3.select(`#${lineName}text`).text('');
                            } else {
                                let textElement = d3.select(`#${lineName}text`);
                                textElement.html(
                                    `<tspan fill="rgb(220,220,220)">${this.SimulatedCorrelationMap[lineName]}</tspan>
                                     <tspan fill="#666">-</tspan>
                                     <tspan fill="rgb(150,150,150)">${this.VerifiedCorrelationMap[lineName]}</tspan>
                                      `
                                );
                            }
        ...
        getHQueryRes(bins, QueryAttrName, QueryContent, PreNoiseKey) {
            let binsData;
            if (this.isSimulation && this.AttrSensitive[QueryAttrName] && !this.isFilter) {
                return JSON.parse(
        ...
        updateAttrHistogram(thisNodeName, data) {
            ...
            return new Promise((resolve) => {
                let prom;
                if(this.VerifiedDataRecord[thisNodeName]) {
                    prom = new Promise((resolve) => {
                        resolve([this.VerifiedDataRecord[thisNodeName]]);
                    });
                }
                else if (this.simulateDataRecord[thisNodeName]) {
                    prom = new Promise((resolve) => {
                            ...
                            if (isNewNode) {
                                ...
                                d3.selectAll(".ContactedAttr").each(function () {
                                    ...
                                    const newLine = LineContainer.append("line")
                                        .attr("id", lineName)
                                        .attr("stroke", VueThis.BaseColorMap["grey-light"])
                                        .attr("stroke-width", 5)
                                        .attr("stroke-dasharray", "5,2")
                                        .on("click", function (event) {
                                            let isChosen = d3.select(this).classed("chosenQuery");
                                            let isExe = d3.select(this).classed("exeQuery");
                                            ...
                                            if (isChosen) {
                                                ...
                                                d3.select(this)
                                                    ...
                                                    .attr("stroke", VueThis.BaseColorMap["blue-normal"]);
                                                if(VueThis.specialAttrList.includes(NodeNameList[0]) || VueThis.specialAttrList.includes(NodeNameList[1])) {
                                                    LineContainer.select(`#${lineName}text`).text('');
                                                }
                                                else {
                                                    if(isExe) {
                                                        LineContainer.select(`#${lineName}text`)
                                                            .html(
                                                            `<tspan fill="rgb(220,220,220)">${VueThis.SimulatedCorrelationMap[lineName]}</tspan>
                                                             <tspan fill="#666">-</tspan>
                                                             <tspan fill="rgb(150,150,150)">${VueThis.VerifiedCorrelationMap[lineName]}</tspan>
                                                             `
                                                        );
                                                    } else {
                                                        LineContainer.select(`#${lineName}text`).html(
                                                            `<tspan fill="rgb(220,220,220)">${VueThis.SimulatedCorrelationMap[lineName]}</tspan>
                                                             <tspan fill="#666">-</tspan>
                                                             <tspan fill="rgb(150,150,150)">?</tspan>
                                                             `
                                    ...
                                    if (isSensitiveQuery) {
                                        ...
                                        LineContainer.append("text")
                                            ...
                                            .attr("y", (y1 + y2) / 2+5)
                                            .attr("text-anchor", "middle")
                                            .attr('fill', VueThis.BaseColorMap['grey-light'])
                                            .text('')
                                            .on("dblclick", function () {
                                                let correlation = +d3.select(this).text().split('-')[0];
...
.ExplorationProgress .vue-slider-dot-handle-disabled {
    visibility: hidden;
}

.ExplorationProgress .vue-slider-dot:last-child {
    display: none;
}
</style>