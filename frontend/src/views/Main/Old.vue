            ...
            <svg class="DBAttrBody">
                ...
                <g class="AttrSetContainer" transform="translate(15, 30)">
                    <g transform="translate(340, -20)">
                        ...
                        ></rect>
                        <text x="25" y="14" class="legendText">Sensitive</text>
                    </g>
                    <g transform="translate(460, -20)">
                        ...
                        ></rect>
                        <text x="25" y="14" class="legendText">Public</text>
                    </g>
                    <g
                            class="DBAttrItemBg"
                            :id="`DBAttrItemBg${i}`"
...
<!--                    ></rect>-->
<!--                </g>-->
<!--                <g class="queryInputLegend" transform="translate(270, 220)">-->
...
<!--                                fill="none"-->
<!--                        ></path>-->
<!--                        <text x="90" y="20" class="legendText">-->
<!--                            Verified distribution (width-95% CI)-->
<!--                        </text>-->
<!--                    </g>-->
<!--                    <path-->
<!--                            d="M30.509,11.34L35.364,19.274L40.218,14.672L45.072,10.04L49.927,19.542L54.781,10L59.635,15.784L64.49,12.107L69.344,18.464L74.199,18.645"-->
...
<!--                            fill="none"-->
<!--                    ></path>-->
<!--                    <text x="90" y="20" class="legendText">Simulated distribution</text>-->
<!--                </g>-->
...
<!--                                                fill="#666"-->
<!--                                                text-anchor="middle"-->
<!--                                                v-if="StrategySpecific[+i]['QueryEpsilonList']"-->
<!--                                        >-->
<!--                                            ε:-->
...
<!--                        </g>-->
                        ...
                        >
                            <g transform="translate(410, -30)">
                                ...
                                ></rect>
                                <text x="50" y="-5" text-anchor="middle" class="legendText">
                                    Count
                                </text>
                                <text x="-10" y="10" text-anchor="end" class="legendText">
                                    {{ CurHeatMapColorScaleLegendList[0].toFixed(0) }}
                                </text>
                                <text x="110" y="10" class="legendText">
                                    {{
...
<!--                                <text x="-80" y="15" text-anchor="middle" class="legendText">-->
<!--                                    Upper bound-->
<!--                                </text>-->
<!--                                <text x="-220" y="20" text-anchor="middle" class="legendText">-->
<!--                                    CI (95%):-->
<!--                                </text>-->
<!--                                <text x="-140" y="90" text-anchor="middle" class="legendText">-->
<!--                                    in bars-->
<!--                                </text>-->
<!--                                <text x="10" y="90" text-anchor="middle" class="legendText">-->
<!--                                    in grids-->
<!--                                </text>-->
<!--                                <text x="107" y="15" text-anchor="middle" class="legendText">-->
<!--                                    Lower bound-->
<!--                                </text>-->
<!--                                <text x="-50" y="45" text-anchor="middle">-->
<!--                                    <tspan x="15" dy="1.2em" class="legendText">Length/2</tspan>-->
<!--                                </text>-->
<!--                            </g>-->
                        </g>
                    </g>
...
export default {
    ...
    computed: {
        ...
        // },
        CurEpsilonNoiseList() {
            let b = 1 / this.CurQueryEpsilonInput;
            let ret = [];
        ...
        CurHeatMapColorScaleLegendList() {
            ...
            if (typeof this.CurHeatMapColorScale === "object") {
                ...
                return d3.range(domain[0], domain[2], (domain[2] - domain[0]) / 50);
            }
        },
        CurNumericalQuery() {
    ...
    methods: {
        ...
        drawQueryResult(
            ...
            if (!rectContainer.empty()) {
                ...
                rectContainerG
                    ...
                    .attr("height", ([category, value]) => Math.max(SvgHeight - 5 - yScale(value), 0))
        ...
        ConfirmAddAttr() {
            if (this.TempAttr !== "") {
                ...
                this.CurQuery.push(this.TempAttr)
            }
            this.AddState = false;
            this.TempAttr = "";
        },
        ...
        deleteExeAttr(attr) {
            ...
            this.CurQuery.splice(this.CurQuery.indexOf(attr), 1);
        },
        ResetHistogram() {
            let simulateData = {};
            ...
            // 多属性的情况
                ...
                Promise.all(PromiseList).then((data) => {
                    ...
                    for (let [queryRes, axisAttr] of data) {
                        Idx += 1;
                        let i1 = Math.floor(Idx / QueryAttrNum);
                    ...
                    QueryAttrNames.forEach((attr1, i1) => {
                        ...
                        QueryAttrNames.forEach((attr2, i2) => {
                            ...
                            this.EpsilonMap[attr1][attr2] = this.CurQueryEpsilonInput;
                            this.QueryConfirmMeta(
                                QueryAttrs,
                                chartContainer,
                                [queryRes, axisAttr],
        ...
        chooseCurQuery(strategyI, queryI) {
            ...
            for (let i in this.CurExeQuery) {
                let granularity =
                    this.StrategySpecific[strategyI]["QueryGranularity"][+i];
                if (granularity == 2) {
                    this.AttrQueryBinRangeMap[this.CurExeQuery[+i]].filter(
                        (d, i) => i % 2 == 0
                    );
                } else {
                    this.AttrQueryBinRangeMap[this.CurExeQuery[+i]].filter(
